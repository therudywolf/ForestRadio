...
| 🐺 | Текстовый позывной на старте (графику убрали ради FLASH) | ✅ в сборке |
...
| — | Спектр включён + пресеты диапазонов РФ (клавиша MENU) | ✅ в сборке |
| E16 | Преднабор каналов: PMR-446 1-8, LPD, служебные (RX) | ✅ в сборке (Reset → ALL) |
| 📡 | Полный частотный пак РФ — 112 каналов (PMR 1-16, LPD 1-69, аэропорты МСК, marine, РЖД, ISS, NOAA) | ✅ CHIRP CSV `presets/ForestRadio-RU.csv` |
